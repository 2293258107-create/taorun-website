export const siteCopy = {
  zh: {
      ...
      categories: [
        {
          title: "餐具 Dinnerware",
          description:
            "反应釉餐盘、碗碟与成套餐具，适合酒店、餐饮与家居零售。",
        },
        {
          title: "杯具 Cups and Mugs",
          description: "马克杯、咖啡杯与茶具系列，覆盖日用与礼品场景。",
        },
        {
          title: "厨房配件",
      ...
      items: [
        {
          ...
          label: "餐具",
          description:
            "反应釉餐盘、碗碟与成套餐具，适用于日用、酒店和餐饮渠道。",
        },
        {
          title: "Cups and Mugs",
          label: "杯具",
          description:
            "马克杯、咖啡杯、茶杯等系列，支持多种釉色与器型搭配。",
        },
        {
          title: "Kitchen Accessories",
          label: "厨房配件",
          description:
            "围绕厨房与餐桌使用场景，提供兼具实用性和装饰感的陶瓷配件。",
        },
        {
          title: "Servingware",
          label: "摆盘器皿",
          description:
            "服务于餐桌陈列、分享餐盘和餐饮摆盘的多样化器皿系列。",
        },
      ],
    },
    story: {
    ...
    products: {
      ...
      items: [
        ...
        { name: "Stoneware Dinnerware", label: "家用餐具系列" },
        { name: "Stoneware Dinnerware", label: "现代餐桌器皿" },
        { name: "Stoneware Dinnerware", label: "陶瓷碗碟套装" },
        { name: "Mug", label: "陶瓷马克杯" },
        { name: "Mug", label: "咖啡杯系列" },
        { name: "Stoneware Dinnerware", label: "精选餐具组合" },
      ],
    },
    works: {
      ...
      title: "最新陶瓷作品展示",
      body:
        "通过器型、釉色和餐桌场景组合，呈现 Top Collection 在日用陶瓷和反应釉工艺上的设计表达。",
      items: [
        { title: "Dinnerware", label: "餐具陈列" },
        { title: "Dinnerware", label: "餐桌搭配" },
        { title: "Coaster", label: "杯垫设计" },
        { title: "Dinnerware", label: "反应釉效果" },
        { title: "Dinnerware", label: "成套餐具" },
      ],
    },
    contact: {
      eyebrow: "Contact Us",
  ...
  en: {
    nav: {
      product: "Products",
      productLink: "Product Categories",
      story: "Our Story",
      ...
      categories: [
        {
          title: "Dinnerware",
          description:
            "Reactive glaze plates, bowls, and dinnerware sets for hotels, restaurants, and home retail.",
        },
        {
          title: "Cups and Mugs",
          description:
            "Mugs, coffee cups, and tea sets for daily use and gifting.",
        },
        {
          title: "Kitchen Accessories",
          description:
      ...
      items: [
        {
          ...
          label: "Dinnerware",
          description:
            "Reactive glaze plates, bowls, and dinnerware sets for daily use, hotels, and restaurants.",
        },
        {
          title: "Cups and Mugs",
          label: "Cups and Mugs",
          description:
            "Mugs, coffee cups, and tea cups with multiple glaze colors and shapes.",
        },
        {
          title: "Kitchen Accessories",
          label: "Kitchen Accessories",
          description:
            "Ceramic accessories for kitchen and tabletop scenarios with practical and decorative value.",
        },
        {
          title: "Servingware",
          label: "Servingware",
    ...
    products: {
      ...
      items: [
        ...
        { name: "Stoneware Dinnerware", label: "Home Dinnerware Series" },
        { name: "Stoneware Dinnerware", label: "Modern Tableware" },
        { name: "Stoneware Dinnerware", label: "Ceramic Bowl and Plate Set" },
        { name: "Mug", label: "Ceramic Mug" },
        { name: "Mug", label: "Coffee Cup Series" },
        { name: "Stoneware Dinnerware", label: "Selected Dinnerware Set" },
      ],
    },
    works: {
      eyebrow: "Our Latest Work",
      title: "Latest Ceramic Work",
      body:
        "Through form, glaze, and tabletop scenes, these pieces show Top Collection's design expression in daily ceramics and reactive glaze craft.",
      items: [
        { title: "Dinnerware", label: "Dinnerware Display" },
        { title: "Dinnerware", label: "Tabletop Styling" },
        { title: "Coaster", label: "Coaster Design" },
        { title: "Dinnerware", label: "Reactive Glaze Finish" },
        { title: "Dinnerware", label: "Dinnerware Set" },
      ],
    },
    contact: {
      eyebrow: "Contact Us",
      ...
      validation: {
        ...
        lastName: "Last name must be at least 1 character",
        email: "Please enter a valid email address",
        subject: "Please select a subject",
        message: "Please add your sourcing need",
      },
      mailBody: (name: string, email: string, message: string) =>
